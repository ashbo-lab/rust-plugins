...
{
    [Info("AdminHunt", "Oegge & ashbo", "0.0.1")]
    [Description("always places Bounty on admins")]
    class AdminHunt : RustPlugin
    {
        ...
        private void Loaded()
        {
            ...
            {
                PrintWarning("ServerRewards not detected, unloading AdminHunt");
        ...
        private object OnEntityTakeDamage(BaseCombatEntity entity, HitInfo info)
        {
            ...
            Console.WriteLine(victim.IsGod());

            // destroy GodMode from players
