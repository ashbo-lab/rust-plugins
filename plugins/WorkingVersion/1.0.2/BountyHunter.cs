...
{
    [Info("BountyHunter", "Oegge & ashbo", "1.0.2")]
...
//sysout            
        ...
        //[bounty.station.list]
        [ChatCommand("bounty.station.list")]
        private void cmdListStation(BasePlayer player, String command, string[] args)
        {
        ...
        private void cmdListBounty(BasePlayer player, String command, string[] args) {
